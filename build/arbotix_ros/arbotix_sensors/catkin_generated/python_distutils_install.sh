...
echo_and_run cd "/home/yang/end/src/arbotix_ros/arbotix_sensors"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/yang/end/src/arbotix_ros/arbotix_sensors/setup.py" \
     \
    build --build-base "/home/yang/end/build/arbotix_ros/arbotix_sensors" \
    install \
    --root="${DESTDIR-/}" \
